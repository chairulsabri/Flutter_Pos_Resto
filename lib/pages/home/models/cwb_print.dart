...
import 'package:flutter_posresto_1/core/extensions/string_ext.dart';
...
class CwbPrint {
  ...
  Future<List<int>> printOrder(
    ...
    bytes += generator.text('s.id/fic14 KUPON: DISKON100',
        styles: const PosStyles(bold: true, align: PosAlign.center));
    bytes += generator.text('Date : Start 6 Februari 2024',
